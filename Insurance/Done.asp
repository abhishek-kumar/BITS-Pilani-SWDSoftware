...
ON ERROR RESUME NEXT
	...
	CheckRecSet.Open "Select * from Insurance where IDNo = '" & UCase(Request.Form("IDNo")) & "'", MainConnection
	If CheckRecSet.recordcount > 0 then
		checkrecset.close
		Response.Redirect("Error.asp?ErrorDesc=You have filled in the information already, U cannot do so again!&ErrorNo=ErrAlreadySubmitted")
	end if
	debugoutput "Select * from Insurance where IDNo = '" & UCase(Request.Form("IDNo")) & "'"
	debugoutput CheckRecSet.recordcount
	DebugOutput "checked for existence"
	checkrecset.close
                ...
                <tr>
                  <td><div id="Inner">
                      <table width="750" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td>&lt;&lt; <a href="Index.asp">Return to main page</a> </td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
