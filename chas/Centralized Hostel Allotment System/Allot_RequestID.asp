      ...
      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30" valign="bottom" background="Images/CT.jpg">
            <div align="left"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style6">Identification:</span> Enter the Application Number of the Candidate </div></td>
        </tr>
        <tr>
          <td background="Images/CC.jpg"><div align="center">
            <form name="form1" method="post" action="Allot_Confirm.asp">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td>
                    <div align="left">&nbsp;
                      <input name="txtAppNo" type="text" id="txtAppNo" size="30" maxlength="15">
                    </div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><div align="right">Preferred Hostel : </div></td>
                  <td>
                    <div align="left">&nbsp;
                      <select name="sHostel" id="sHostel">
                        <option value="0" selected>Select a Hostel</option>
                ...
                <tr>
                  ...
                  <td colspan="2"><div align="center">
                    <input name="btnSubmit" type="submit" id="btnSubmit" value="Submit Application Number">
                  </div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
