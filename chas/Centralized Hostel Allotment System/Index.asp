              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td colspan="2"><div align="left">
                    <p>Welcome to the centralized Hostel Allotment System. You may allot hostels to students in order of the preference (or sequence) number only.</p>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><div align="right">&gt;&gt;</div></td>
                  <td><div align="left">&nbsp;&nbsp;&nbsp;<a href="Allot_RequestID.asp">Allot Hostel Rooms to New Students </a></div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><div align="right">&gt;&gt;</div></td>
                  <td><div align="left">&nbsp;&nbsp;&nbsp;<a href="Allot_Status.asp">View Status</a>&nbsp;&nbsp;[Click &lt;<a href="Allot_Status_NoRefresh.asp">here</a>&gt; for Status <em>without</em> Autorefresh]</div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td>
                    <div align="left">&nbsp;&nbsp;&nbsp;<strong>View Printable Details of this Candidate</strong>:<br>
&nbsp;&nbsp;&nbsp;<span class="style9">Application Number:</span>
  <input name="txtAppNo" type="text" id="txtAppNo" value="(App Number)" size="15" maxlength="20">
                    &nbsp;
                      <input type="submit" name="Submit" value="View Printable Details">
                    </div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
